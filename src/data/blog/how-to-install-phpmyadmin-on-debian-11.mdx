...
Jika kalian sudah melakukan install LAMP pada server Debian, kalian bisa skip tutorial ini dan langsung saja ke [tutorial install phpMyAdmin](https://taufikcrisnawan.dev/blog/how-to-install-phpmyadmin-oh-debian-11#)
