...
![Thumbnail](https://ik.imagekit.io/taufik/install-phpmyadmin-debian-11/thumbnail.png 'Thumbnail')
...
Jika kalian sudah melakukan install LAMP pada server Debian, kalian bisa skip tutorial ini dan langsung saja ke [tutorial install phpMyAdmin](https://taufikcrisnawan.dev/blog/how-to-install-phpmyadmin-on-debian-11#download-phpmyadmin)
...
![Status Apache](https://ik.imagekit.io/taufik/install-phpmyadmin-debian-11/status-apache.png 'Status Apache')
...
![PHP Version](https://ik.imagekit.io/taufik/install-phpmyadmin-debian-11/php-version.png 'PHP Version')
...
![Status MariaDB](https://ik.imagekit.io/taufik/install-phpmyadmin-debian-11/status-mariadb.png 'Status MariaDB')
...
![Secure MariaDB](https://ik.imagekit.io/taufik/install-phpmyadmin-debian-11/secure-mariadb.png 'Secure MariaDB')
...
![Download phpMyAdmin](https://ik.imagekit.io/taufik/install-phpmyadmin-debian-11/download-phpmyadmin.png 'Download phpMyAdmin')
...
```
![GPG Key](https://ik.imagekit.io/taufik/install-phpmyadmin-debian-11/keyring.png 'GPG Key')
...
![Verify phpMyAdmin](https://ik.imagekit.io/taufik/install-phpmyadmin-debian-11/verify-phpmyadmin.png 'Verify phpMyAdmin')
...
![blowfish_secret](https://ik.imagekit.io/taufik/install-phpmyadmin-debian-11/blowfish.png 'blowfish_secret')
...
![Login Page phpMyAdmin](https://ik.imagekit.io/taufik/install-phpmyadmin-debian-11/login-page.png 'Login Page phpMyAdmin')
