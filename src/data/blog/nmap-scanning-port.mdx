...
published: '1/19/2023'
topics: ['network']
keywords: ['networ', 'network protocol', 'scanning port', 'nmap', 'nmap tool', 'port checker']
related: []
---
...
![Debian Nmap](https://ik.imagekit.io/taufik/blog/nmap-scanning-port/debian-scanning.png 'Debian Nmap')
...
<Callout type='warning'>
  Penggunaan Nmap harus dilakukan dengan bijak dan hanya pada sistem atau jaringan yang Anda miliki izin untuk mengecek.
  Port scanning tanpa izin dapat dianggap sebagai tindakan ilegal dan merugikan.
</Callout>
