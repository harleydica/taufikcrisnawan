...
```
Dibawah ini contoh menambahkan barisnya:
![Menambahkan Baris Node Master](https://ik.imagekit.io/taufik/blog/replication-master-slave-mariadb-debian-11/master-node-file.png.png 'Menambahkan Baris Node Master')
...
relay_log_index         = /var/log/mysql/mysql-relay-bin.index
```
![Menambahkan Baris Node Slave](https://ik.imagekit.io/taufik/blog/replication-master-slave-mariadb-debian-11/slave-node-file.png.png 'Menambahkan Baris Node Slave')
...
INSERT INTO table-database VALUES (2,"Muhammad Ichsanul Fadhil","Ichsan");
```
