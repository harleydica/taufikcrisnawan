...
The name fields are the name of our website, we can name it whatever we want, fill in the domain field with your website's domain that you want to monitor, e.g: `coba.taufikcrisnawan.dev`, and click **save**.
        ...
        <Head>
          ...
          {process.env.NODE_ENV === 'production' && (
            <script
              ...
              src='https://umami.coba.taufikcrisnawan.dev/umami.js'
            />
          )}
          {/* other stuff here... */}
        </Head>
