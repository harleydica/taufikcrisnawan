...
Pastikan sebelum melakukan konfigurasi IP Host kalian bisa saling connect (1 network), untuk perintahnya:

```bash
hostname -I
```

Pada node yang saya gunakan menggunakan IP Host seperti dibawah ini:
