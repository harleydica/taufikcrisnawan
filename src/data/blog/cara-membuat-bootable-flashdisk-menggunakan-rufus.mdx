...
keywords: ['bootable flashdisk', 'operating system', 'rufus', 'bootable', 'os', 'debian']
related: []
---
...
![Bootable Rufus](https://ik.imagekit.io/taufik/blog/cara-membuat-bootable-flashdisk-menggunakan-rufus/tampilan-awal.png 'Bootable Rufus')
...
![Download Rufus](https://ik.imagekit.io/taufik/blog/cara-membuat-bootable-flashdisk-menggunakan-rufus/tampilan-download.png 'Download Rufus')
...
![Rufus](https://ik.imagekit.io/taufik/blog/cara-membuat-bootable-flashdisk-menggunakan-rufus/tampilan-rufus.png 'Rufus')
...
![Pilih Device](https://ik.imagekit.io/taufik/blog/cara-membuat-bootable-flashdisk-menggunakan-rufus/tampilan-pilih-device.png 'Pilih Device')
...
![Select ISO](https://ik.imagekit.io/taufik/blog/cara-membuat-bootable-flashdisk-menggunakan-rufus/tampilan-select-iso.png 'Select ISO')
Pilih file ISO lalu klik **Open**
![Cari File ISO](https://ik.imagekit.io/taufik/blog/cara-membuat-bootable-flashdisk-menggunakan-rufus/tampilan-klik-iso.png 'Cari File ISO')
...
![Partition Scheme](https://ik.imagekit.io/taufik/blog/cara-membuat-bootable-flashdisk-menggunakan-rufus/tampilan-partition-scheme.png 'Partition Scheme')

### Format Options

Pada Format Options ini kalian bisa mengikuti default rekomendasi yang otomatis terpilih saat memasukan file ISO.
![Format Options](https://ik.imagekit.io/taufik/blog/cara-membuat-bootable-flashdisk-menggunakan-rufus/tampilan-format-options.png 'Format Options')

### Klik Start untuk Memulai proses

Jika sudah yakin dengan settingannya, kalian bisa klik **START**.
![Click START](https://ik.imagekit.io/taufik/blog/cara-membuat-bootable-flashdisk-menggunakan-rufus/tampilan-start.png 'Click START')

Pada operating system tertentu akan muncul ISO Hybrid Image Detected, kalian bisa ikuti pilihan yang disarankan.
![ISO Hybrid Image Detected](https://ik.imagekit.io/taufik/blog/cara-membuat-bootable-flashdisk-menggunakan-rufus/tampilan-isohybrid.png 'ISO Hybrid Image Detected')
...
![Attention](https://ik.imagekit.io/taufik/blog/cara-membuat-bootable-flashdisk-menggunakan-rufus/tampilan-attention.png 'Attention')
...
![Proses](https://ik.imagekit.io/taufik/blog/cara-membuat-bootable-flashdisk-menggunakan-rufus/tampilan-status.png 'Proses')

Jika **Status** menunjukkan **READY** berarti proses pembuatan bootable flashdisk sudah selesai. Mudah tidak? Tentu mudah hehe😉.
![Finish Ready](https://ik.imagekit.io/taufik/blog/cara-membuat-bootable-flashdisk-menggunakan-rufus/tampilan-ready.png 'Finish Ready')
