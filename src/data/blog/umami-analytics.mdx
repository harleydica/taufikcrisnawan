...
keywords: ['umami', 'analytics', 'google', 'google analytics', 'web analytics', 'analytics']
related: []
---
...
<Callout>
  Untuk Umami versi lama kalian diharuskan mengisi query sql pada Supabase. Namun, sekarang kalian hanya klik{' '}
  <Kbd>Deploy</Kbd> pada Vercel seperti diatas dan mengisi enviroment, dengan otomatis database Umami akan terisi.
</Callout>
