...
const classes: Record<CalloutType, string> = {
  ...
  error: clsx('border-red-900 bg-red-600 text-red-50 dark:border-red-200/30 dark:bg-red-900/30 dark:text-red-200'),
  info: clsx('border-blue-900 bg-blue-600 text-blue-50 dark:border-blue-200/30 dark:bg-blue-900/30 dark:text-blue-200'),
  warning: clsx(
...
const Callout = (props: CalloutProps) => {
  ...
  return (
    <div className={clsx('mt-6 flex items-center rounded-lg border py-2 pr-4', classes[type])}>
      <div
